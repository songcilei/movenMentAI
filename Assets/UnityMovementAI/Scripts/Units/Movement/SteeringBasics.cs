...
namespace UnityMovementAI
{
    ...
    public class SteeringBasics : MonoBehaviour
    {
        ...
        public Vector3 Arrive(Vector3 targetPosition)
        {
            ...
            //确定直线加速度的正确方向
            Vector3 targetVelocity = targetPosition - rb.Position;//rb.Position = targetPosition
            //Debug.Log("Displacement " + targetVelocity.ToString("f4"));

            /* Get the distance to the target */
            float dist = targetVelocity.magnitude;//向量的长度
            ...
            /*不是在1秒内加速到正确的速度，
            *加速使我们在timeToTarget秒内达到期望的速度
            *(如果我们实际加速到full timeToTarget秒)。*／
